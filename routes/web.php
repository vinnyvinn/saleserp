...
Route::group(['middleware' => 'auth'], function () {
     ...
     */
     ...
     Route::post('accounts/New-contact', [
         'as' => 'accounts.addcontacts',
         'uses' => 'AccountsController@addcontacts'
     ]);
     Route::post('accounts/{account}update-contact', [
        'as' => 'accounts.updateaccount',
        'uses' => 'AccountsController@update'
    ]);
    Route::post('accounts/New-Opportunity', [
        'as' => 'accounts.addopportunity',
        'uses' => 'AccountsController@addoppotunity'
    ]);

    Route::get('opportunity/list', [
        'as' => 'opportunity',
        'uses' => 'AccountsController@opportunity'
    ]);

    //Leads
    Route::resource('leads', 'LeadsController');
    Route::post('leads/status/create', [
        'as' => 'leads/status',
        'uses' => 'SettingsController@addleadstatus'
    ]  
    );
