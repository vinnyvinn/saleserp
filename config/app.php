...
return [
    ...
    | and it will se application name defined from Dsc settings page.
    |
    */
...
//        Illuminate\Redis\RedisServiceProvider::class,
        ...
        Dsc\Providers\HtmlServiceProvider::class,
         ...
         */
        Dsc\Services\Auth\Api\JWTServiceProvider::class,
        Dsc\Providers\AppServiceProvider::class,
        Dsc\Providers\AuthServiceProvider::class,
