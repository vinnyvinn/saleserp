...
@section('scripts')
    ...
    {!! JsValidator::formRequest('Dsc\Http\Requests\User\UpdateDetailsRequest', '#details-form') !!}
    {!! JsValidator::formRequest('Dsc\Http\Requests\User\UpdateProfileLoginDetailsRequest', '#login-details-form') !!}

    @if (settings('2fa.enabled'))
        {!! JsValidator::formRequest('Dsc\Http\Requests\User\EnableTwoFactorRequest', '#two-factor-form') !!}
    @endif
@stop