...
namespace Dsc\Http\Controllers\Web\Auth;

use Dsc\Events\User\LoggedIn;
use Dsc\Events\User\LoggedOut;
use Dsc\Events\User\Registered;
use Dsc\Http\Requests\Auth\LoginRequest;
use Dsc\Http\Requests\Auth\RegisterRequest;
use Dsc\Repositories\Role\RoleRepository;
use Dsc\Repositories\User\UserRepository;
use Dsc\Services\Auth\TwoFactor\Contracts\Authenticatable;
