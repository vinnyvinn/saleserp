...
use Dsc\Events\User\Created;
use Dsc\Events\User\Deleted;
...
use Dsc\Events\User\ResetedPasswordViaEmail;
...
use Dsc\Events\User\UserEventContract;
...
class UserEventsSubscriber
{
    ...
    {
        $class = 'Dsc\Listeners\UserEventsSubscriber';
